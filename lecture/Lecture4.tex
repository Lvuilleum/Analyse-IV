...
The coefficient $c_{-1}$ is called the \textbf{Residue} of $f$ at $z_0$, denoted $\text{Res}(f, z_0)$.
\begin{align*}
    \int_\gamma f(z) \, dz = 2 \pi i \sum_{k=1}^m \text{Res}(f, z_k)
\end{align*}
This is the most powerful "trick" to solve integrals where $\gamma$ encloses several poles $z_k$.
